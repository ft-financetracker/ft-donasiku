(()=>{
  ...
  const legacyKeys=(p,q,c)=>[`kia_catalog_v055_${p}_${c}_${q.toLowerCase().slice(0,80)}`,`kia_catalog_v054_${p}_${c}_${q.toLowerCase().slice(0,80)}`,`kia_catalog_v052_${p}_${c}_${q.toLowerCase().slice(0,80)}`,`kia_catalog_v051_${p}_${c}_${q.toLowerCase().slice(0,80)}`];
  ...
  function bootstrapSeed(){
    try{
      for(const k of ['kia_public_bootstrap_v056','kia_public_bootstrap_v055','kia_public_bootstrap_v054','kia_public_bootstrap_v052','kia_public_bootstrap_v051']){
